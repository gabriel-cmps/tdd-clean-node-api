...
describe('Auth UseCase', () => {
  ...
  test('Should throw if no password is provided', async () => {
    const { sut } = makeSut()
    const promise = sut.auth('any_email@example.com')
    expect(promise).rejects.toThrow(new MissingParamError('password'))
  })

  test('Should call LoadUserByEmailRepository with correct email', async () => {
    const { sut, loadUserByEmailRepositorySpy } = makeSut()
    await sut.auth('any_email@example.com', 'any_password')
    expect(loadUserByEmailRepositorySpy.email).toBe('any_email@example.com')
  })
  ...
  test('Should call Encrypter with correct values', async () => {
    ...
    await sut.auth('valid_email@example.com', 'any_password')
  ...
  test('Should call TokenGenerator with correct userId', async () => {
    ...
    await sut.auth('valid_email@example.com', 'valid_password')
